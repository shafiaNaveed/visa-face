...
function Connected() {
  return (
    <div className='w-[1440px] flex flex-col text-center items-center h-[3793px] bg-gradient-to-tr from-blue-300 via-white to-orange-300 relative rounded-tr-[30px] rounded-tl-[30px]'>
          ...
          <div className='flex flex-col w-[400px] h-[200px] relative top-32'>
          ...
          <div className='w-[400px] items-center rounded-[32px] flex flex-row h-[55px] relative top-32 bg-blue-600'>
